...
class SwerveDriveController(Node):
    ...
    def timer_callback(self):
        ...
        self.joint_state.position = [
            5.0,  # right_front_connector_joint (Wheel 1)
            5.0,  # left_front_connector_joint (Wheel 2)
            wheel_angles[2],  # left_back_connector_joint (Wheel 3)
            wheel_angles[3],  # right_back_connector_joint (Wheel 4)
            wheel_angles[3],  # Placeholder for wheel rotation (not necessary for velocity control)
            wheel_angles[3],  # Placeholder for wheel rotation
            wheel_angles[3],  # Placeholder for wheel rotation
            wheel_angles[3],  # Placeholder for wheel rotation
            wheel_angles[3],
            wheel_angles[3],
